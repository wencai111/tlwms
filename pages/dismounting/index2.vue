<template>
	<view class="content">
		<view class="example">
			...
			<button type="primary" v-bind:disabled="currentSteps > 1" v-on:click="scanMaterial"><text>扫入库码</text></button>
			...
			<view v-show="sureInlibrarys" class="uni-textarea">
                <textarea placeholder-style="color:#F76260" v-model="material.reason" placeholder="请填写组装入库的原因"/>
            </view>
			<button type="primary" v-bind:disabled="!sureInlibrarys" @click="sureInlibrary">确认组装入库</button>
