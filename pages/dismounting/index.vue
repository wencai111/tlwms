<template>
	<view class="content">
		<view class="example">
			...
			<button type="primary" v-bind:disabled="currentSteps > 1" v-on:click="scanMaterial"><text>扫入物料</text></button>
			...
			<button type="primary" v-bind:disabled="!sureInlibrarys" @click="sureInlibrary">确认分拆入库</button>
