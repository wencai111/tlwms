				...
				<view class="uni-card">
					...
					<view class="uni-card__content uni-card__content--pd">
						<view v-for="item in material.goods" v-bind:key="item" class="wxc-list">
							<view class="wxc-list-title-text">{{material.storage==null?'正在等待库位码，可继续物料':'出库货架'}}
					...
					<view class="uni-card__footer">紧急出库:{{material.code}}<text v-if="material.storage!=null">{{material.storage.code}}</text></view>
				</view>
			</view>
			<button type="primary" v-bind:disabled="!sureOutlibrarys" @click="sureOutlibrary">
				确认出库
			</button>
